...
// Main program
int main() {
    Student s1("Rishika", 18, "S101", "9999", "2023-08-01", "BTech CSE", 3.8);
    Student s2("Aman", 19, "S102", "8888", "2023-08-01", "BTech IT", 3.5);

    Professor p1("Dr. Mehta", 45, "P201", "7777", "CSE", "AI", "2015-07-10");
    Professor p2("Dr. Singh", 50, "P202", "6666", "ECE", "VLSI", "2010-05-21");
